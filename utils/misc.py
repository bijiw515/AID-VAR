...
class MetricLogger(object):
    ...
    def reset(self):
        """Clear stored meters—for new epoch logging."""
        self.meters.clear()
        self.iter_end_t = time.time()
...
# ---------------- checkpoint utils ---------------- #
def find_latest_ckpt(dir_path: str, prefix: str = "ckpt"):
    """Return latest ckpt path under dir_path with given prefix, else None."""
    pattern = os.path.join(dir_path, f"{prefix}*.pth")
